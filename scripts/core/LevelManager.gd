...
const DEFAULT_LEVELS: Dictionary = {
	...
	6: {
		...
		"available_package_types": [0, 2, 4],
		"available_powerups": ["slow_motion"],
		"max_lives": 3,
		"max_saturation": 100.0,
		"max_queue_size": 4,
	...
	7: {
		...
		"spawn_interval": 1.8,
		"available_colors": ["azul", "rojo", "verde", "amarillo", "morado"],
		"available_package_types": [0, 2, 4, 1],
		"available_powerups": ["slow_motion", "double_points"],
		"max_lives": 3,
		"max_saturation": 100.0,
		"max_queue_size": 4,
		"allow_order_cancel": true,
	...
	8: {
		...
		"spawn_interval": 1.6,
		"available_colors": ["azul", "rojo", "verde", "amarillo", "morado"],
		"available_package_types": [0, 2, 4, 1, 3],
		"available_powerups": ["slow_motion", "double_points", "bomb_cleaner"],
		"max_lives": 3,
		"max_saturation": 100.0,
		"max_queue_size": 4,
		"allow_order_cancel": true,
	...
	9: {
		...
		"spawn_interval": 1.5,
		"available_colors": ["azul", "rojo", "verde", "amarillo", "morado"],
		"available_package_types": [0, 2, 4, 1, 3, 5],
		"available_powerups": ["slow_motion", "double_points", "bomb_cleaner", "auto_correct"],
		"max_lives": 3,
		"max_saturation": 100.0,
		"max_queue_size": 5,
		"allow_order_cancel": true,
	...
	10: {
		...
		"available_colors": ["azul", "rojo", "verde", "amarillo", "morado"],
		"available_package_types": [0, 2, 4, 1, 3, 5],
		"available_powerups": ["slow_motion", "double_points", "bomb_cleaner", "auto_correct", "perfect_suction", "preview"],
		"max_lives": 3,
		"max_saturation": 100.0,
		"max_queue_size": 5,
		"allow_order_cancel": true,
